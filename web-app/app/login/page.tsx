  ...
  return (
    <div className="min-h-screen bg-white dark:bg-slate-900 flex items-center justify-center p-4">
      <div className="w-full max-w-4xl flex rounded-3xl shadow-2xl overflow-hidden border border-slate-200 dark:border-slate-700">
        ...
        <div className="hidden md:flex md:w-5/12 bg-linear-to-b from-pink-50/80 via-white to-purple-50/80 flex-col items-center justify-center p-8 relative">
          ...
          <h2 className="text-lg font-bold text-center mt-4">
            ...
            <span className="bg-linear-to-r from-pink-500 to-purple-600 bg-clip-text text-transparent text-base">
          ...
          <div className="w-full max-w-sm">
            ...
            {!isProcessing && (
              <form className="space-y-4" onSubmit={handleSubmit}>
                ...
                <div>
                  ...
                  <div className="relative">
                    <input
                      ...
                      className="w-full px-4 py-3 pr-20 rounded-xl border border-slate-200 dark:border-slate-600 bg-white dark:bg-slate-900 text-slate-900 dark:text-white focus:outline-none focus:ring-2 focus:ring-pink-500"
                      required
                    />
                    <button
                      type="button"
                ...
                <button
                  type="submit"
                  className="w-full py-3.5 px-4 bg-linear-to-r from-pink-500 to-purple-600 hover:from-pink-600 hover:to-purple-700 text-white font-semibold rounded-xl transition-all duration-200 flex items-center justify-center gap-3 shadow-lg shadow-pink-500/25 hover:shadow-pink-500/40"
                >
